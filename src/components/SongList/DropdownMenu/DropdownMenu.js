...
function DropdownMenu({ isOpen, index }) {
  ...
  //   const [left, right] = [
  //     sampleSong.buffer.getChannelData(0),
  //     sampleSong.buffer.getChannelData(1),
  //   ];
  //   // interleaved
  ...
  //     numChannels: sampleSong.buffer.numberOfChannels,
  //     sampleRate: sampleSong.buffer.sampleRate,
  //   });

  //   console.error(visibleSongs, sampleSong.index);
  //   window.electron.ipcRenderer.sendMessage(
  //     'SAVE_SONG',
  //     wavBytes,
  //     visibleSongs[sampleSong.index].file
  //   );
  // }
